<x-admin.layout>
    <x-admin.breadcrumb title='Metatags Create' :links="[
    ...
    <form action="{{ route('admin.metatags.store', ['global' => request('global')]) }}" method="POST" id="tags_form">
        @csrf
        @if (!request('global'))
        ...
        <div class="row" id="tags_row">
            <div class="col-lg-4 col-md-6">
                <div class="card shadow-sm mb-2" id="first_tag">
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <label for="">Meta tag <span class="text-danger">*</span></label>
                            <div class="d-flex">
                                <div class="flex-fill">
                                    <input type="text" name="tags[]" class="form-control" value="" required>
                                </div>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <textarea name="contents[]" class="form-control" rows="2" required></textarea>
                        </div>
                    </div>
                </div>
            </div>
